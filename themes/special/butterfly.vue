    ...
    for(let i=0;i<8;i++){
        ...
        b.innerHTML = `
            <div style="width:${size}px; height:${size}px; display:flex; justify-content:center; align-items:center;">
                <svg class="butterfly-wing butterfly-wing-left" viewBox="0 0 30 60" style="width:50%; height:100%; fill:var(--primary); opacity:0.8;">
                    <path d="M30 30c-4-4-10-8-15-4 0 6 5 8 9 9-5 1-9 5-9 9 6 0 10-4 15-8 5 4 9 8 15 8z"/>
                </svg>
                <svg class="butterfly-wing butterfly-wing-right" viewBox="30 0 30 60" style="width:50%; height:100%; fill:var(--primary); opacity:0.8;">
                    <path d="M30 30c4-4 10-8 15-4 0 6-5 8-9 9 5 1 9 5 9 9-6 0-10-4-15-8-5 4-9 8-15 8z"/>
                </svg>
            </div>
        `;
...
<template>
    ...
    <div class="antialiased font-['Jost',sans-serif] bg-[var(--cream)] text-[var(--ink)] overflow-x-hidden pb-[100px]">

        <!-- DESKTOP LEFT SIDE (Fixed) -->
        <div class="hidden lg:flex fixed inset-y-0 left-0 right-[420px] flex-col items-center justify-center bg-[var(--cream)] overflow-hidden border-r border-[var(--primary-soft)]/30">
            <!-- Ornaments Desktop -->
            <div class="absolute top-[-40px] left-[-40px] w-96 opacity-70 pointer-events-none" style="transform: scale(-1,-1);">
                <img :src="asset('butterfly-corner.png')" class="w-full anim-pulse">
            </div>
            <div class="absolute top-[-40px] right-[-40px] w-96 opacity-70 pointer-events-none" style="transform: rotate(-90deg);">
                <img :src="asset('butterfly-corner.png')" class="w-full anim-pulse-delay">
            </div>
            <div class="absolute bottom-[-40px] left-[-40px] w-96 opacity-70 pointer-events-none" style="transform: scaleX(-1);">
                <img :src="asset('butterfly-corner.png')" class="w-full anim-pulse-delay">
            </div>
            <div class="absolute bottom-[-40px] right-[-40px] w-96 opacity-70 pointer-events-none" style="transform: scaleY(-1) rotate(-90deg);">
                <img :src="asset('butterfly-corner.png')" class="w-full anim-pulse">
            </div>

            <!-- Background subtle texture - butterfly shaped pattern -->
            <div class="absolute inset-0 opacity-[0.05] pointer-events-none" style="background-image: url('data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M30 30c-4-4-10-8-15-4 0 6 5 8 9 9-5 1-9 5-9 9 6 0 10-4 15-8 5 4 9 8 15 8 0-4-4-8-9-9 4-1 9-3 9-9-5-4-11 0-15 4z\' fill=\'%239B6B9E\' fill-opacity=\'0.8\' fill-rule=\'evenodd\'/%3E%3C/svg%3E'); background-size: 60px 60px;"></div>
        ...
        <div id="app-wrap" class="w-full lg:w-[420px] lg:ml-auto min-h-screen relative bg-[var(--cream)] shadow-[-10px_0_30px_rgba(0,0,0,0.1)]">

            <!-- floating butterflies -->
            <div ref="petalsContainer" class="fixed inset-y-0 right-0 w-full lg:w-[420px] pointer-events-none z-40 overflow-hidden"></div>
            ...
            <div v-if="!opened" class="fixed top-0 bottom-0 right-0 w-full lg:w-[420px] z-50 bg-[var(--cream)] overflow-y-auto overflow-x-hidden">
                <div class="relative max-w-md w-full mx-auto min-h-full flex flex-col p-4">
                    <div class="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                        <div class="corner-wrap corner-tl"><img :src="asset('butterfly-corner.png')" alt="" class="corner-img"></div>
                        <div class="corner-wrap corner-br"><img :src="asset('butterfly-corner.png')" alt="" class="corner-img"></div>
                    </div>

                    <div class="glass-panel w-full text-center py-10 px-4 my-auto relative z-10">
                        <p class="font-serif tracking-[0.35em] text-[10px] text-[var(--primary)] uppercase mb-4">The Wedding Of</p>
                        ...
                        <div class="photo-frame">
                            ...
                            <img :src="asset('butterfly-center.png')" alt="" class="corner-bottom">
                        </div>
                        
                        <div v-if="coverPhotos.length > 1" class="flex gap-1.5 mt-2 justify-center">
                            <span
                                v-for="(photo, index) in coverPhotos"
                                :key="'dot-' + index"
                                class="h-1.5 w-1.5 rounded-full transition-colors"
                                :class="index === activeCoverIndex ? 'bg-[var(--ink)]' : 'bg-[var(--primary-soft)]'"
                            ></span>
                        </div>
                        ...
                        <div class="divider-line w-20 mx-auto my-4"></div>
            ...
            <div v-show="opened">
                ...
                <section id="hero" class="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
                    <div class="corner-wrap corner-tr"><img :src="asset('butterfly-corner.png')" alt="" class="corner-img"></div>
                    <div class="corner-wrap corner-bl"><img :src="asset('butterfly-corner.png')" alt="" class="corner-img"></div>
                    
                    <!-- Hero Butterflies Decorations -->
                    <svg class="absolute top-32 right-12 w-12 h-12 text-[var(--primary)] opacity-40 animate-pulse" style="transform: rotate(15deg)" viewBox="0 0 60 60" fill="currentColor">
                        <path d="M30 30c-4-4-10-8-15-4 0 6 5 8 9 9-5 1-9 5-9 9 6 0 10-4 15-8 5 4 9 8 15 8 0-4-4-8-9-9 4-1 9-3 9-9-5-4-11 0-15 4z"/>
                    </svg>
                    <svg class="absolute bottom-40 left-10 w-8 h-8 text-[var(--ink)] opacity-30 animate-bounce" style="transform: rotate(-25deg)" viewBox="0 0 60 60" fill="currentColor">
                        <path d="M30 30c-4-4-10-8-15-4 0 6 5 8 9 9-5 1-9 5-9 9 6 0 10-4 15-8 5 4 9 8 15 8 0-4-4-8-9-9 4-1 9-3 9-9-5-4-11 0-15 4z"/>
                    </svg>

                    <div class="glass-panel w-full max-w-md mx-auto text-center px-6 py-16">
                        <p class="reveal font-serif tracking-[0.4em] text-xs uppercase text-[var(--primary)] mb-6">The Wedding Of</p>

                        <div class="reveal photo-frame mb-6">
                            <div class="photo-ring">
                                <img
                                    v-for="(photo, index) in coverPhotos"
                                    :key="photo + index"
                        ...
                        <div v-if="coverPhotos.length > 1" class="reveal flex gap-1.5 mt-2 justify-center mb-6 -mt-2 relative z-10">
                            <span
                                v-for="(photo, index) in coverPhotos"
                                :key="'dot-' + index"
                                class="h-1.5 w-1.5 rounded-full transition-colors"
                        ...
                        <h1 class="reveal font-script text-7xl md:text-8xl mb-4" style="color:var(--ink)">
                            {{ groom?.nickname ?? groom?.full_name }} &amp; {{ bride?.nickname ?? bride?.full_name }}
                        </h1>
                        <p class="reveal font-serif text-lg text-[var(--ink)]/80">{{ heroDateText }}</p>
                        <div class="reveal divider-line w-32 mx-auto my-8"></div>
                ...
                <section class="relative px-4 py-12 overflow-hidden">
                    <div class="glass-panel w-full max-w-md mx-auto text-center px-6 py-12">
                        ...
                        <p class="reveal font-serif text-sm text-[var(--primary)] mt-6">{{ quoteSource }}</p>
                    </div>
                </section>
                ...
                <section id="acara" class="relative px-4 py-16 overflow-hidden">
                    ...
                    <div class="glass-panel w-full max-w-md mx-auto text-center px-6 py-16">
                        <p class="reveal font-serif tracking-[0.35em] text-xs uppercase text-[var(--primary)] mb-8">Save The Date</p>
                        ...
                        <div class="grid gap-8">
                            <div v-if="akad" class="reveal border border-[var(--primary-soft)]/50 rounded-xl p-8 bg-white/50 shadow-sm relative overflow-hidden">
                                <svg class="absolute -right-4 -bottom-4 w-20 h-20 text-[var(--primary)] opacity-10" viewBox="0 0 60 60" fill="currentColor">
                                    <path d="M30 30c-4-4-10-8-15-4 0 6 5 8 9 9-5 1-9 5-9 9 6 0 10-4 15-8 5 4 9 8 15 8 0-4-4-8-9-9 4-1 9-3 9-9-5-4-11 0-15 4z"/>
                                </svg>
                                <h3 class="font-serif text-2xl mb-1 relative z-10">Akad Nikah</h3>
                                <p class="font-script text-4xl my-2 text-[var(--primary)] relative z-10">{{ formatLongDate(akad.date) }}</p>
                            ...
                            <div v-if="resepsi" class="reveal border border-[var(--primary-soft)]/50 rounded-xl p-8 bg-white/50 shadow-sm relative overflow-hidden">
                                <svg class="absolute -left-4 -bottom-4 w-20 h-20 text-[var(--primary)] opacity-10" style="transform: scaleX(-1)" viewBox="0 0 60 60" fill="currentColor">
                                    <path d="M30 30c-4-4-10-8-15-4 0 6 5 8 9 9-5 1-9 5-9 9 6 0 10-4 15-8 5 4 9 8 15 8 0-4-4-8-9-9 4-1 9-3 9-9-5-4-11 0-15 4z"/>
                                </svg>
                                <h3 class="font-serif text-2xl mb-1 relative z-10">Resepsi</h3>
                                <p class="font-script text-4xl my-2 text-[var(--primary)] relative z-10">{{ formatLongDate(resepsi.date) }}</p>
                ...
                <section id="lovestory" class="relative px-4 py-16 overflow-hidden">
                    ...
                    <div class="glass-panel w-full max-w-md mx-auto text-center px-6 py-16">
                        <p class="reveal font-serif tracking-[0.35em] text-xs uppercase text-[var(--primary)] mb-2">Our Journey</p>
                        ...
                        <div class="text-left space-y-10">
                            <div v-for="item in invitation.love_stories" :key="item.id" class="reveal flex gap-5">
                                <div class="w-2 h-2 rounded-full bg-[var(--gold)] mt-2 shrink-0 shadow-[0_0_8px_var(--gold)]"></div>
                                <div>
                ...
                <section id="galeri" class="relative px-4 py-16 overflow-hidden">
                    ...
                    <div class="glass-panel w-full max-w-md mx-auto text-center p-4">
                        <p class="reveal font-serif tracking-[0.35em] text-xs uppercase text-[var(--primary)] mb-2 mt-8">Gallery</p>
                        <h2 class="reveal font-script text-5xl mb-8">Our Moments</h2>
                        
                        <!-- Carousel Container -->
                        <div class="reveal relative bg-white/50 p-2 rounded-2xl shadow-sm border border-white/50 mb-8">
                            <!-- Main Image -->
                            ...
                            <div ref="thumbsWrap" class="relative flex gap-2 overflow-x-auto py-1 px-1 snap-x hide-scrollbar">
                                <img 
                                    ...
                                    :class="idx === currentGalIdx ? 'border-2 border-[var(--primary)]' : 'opacity-60 hover:opacity-100'"
                                >
                            </div>
                        </div>
                    </div>
                ...
                <section v-if="invitation?.accounts?.length" id="kado" class="relative px-4 py-16 overflow-hidden">
                    ...
                    <div class="glass-panel w-full max-w-md mx-auto text-center px-6 py-16">
                        <p class="reveal font-serif tracking-[0.35em] text-xs uppercase text-[var(--primary)] mb-2">Wedding Gift</p>
                        ...
                        <div class="grid gap-6 text-left">
                            <div v-for="account in invitation.accounts" :key="account.id" class="reveal border border-[var(--primary-soft)]/50 bg-white/50 rounded-xl p-6 shadow-sm">
                                <p class="text-xs tracking-widest uppercase text-[var(--primary)] mb-2">{{ account.bank_name }}</p>
                                ...
                                <button @click="copyAccount(account.account_number)" class="text-xs tracking-widest uppercase border-b border-[var(--ink)] pb-1 hover:text-[var(--primary)] transition-colors">Salin Nomor</button>
                            </div>
                        </div>
                        
                        <div v-if="invitation?.gift_address" class="reveal mt-6 border border-[var(--primary-soft)]/50 bg-white/50 rounded-xl p-6 text-left shadow-sm">
                            <p class="text-xs tracking-widest uppercase text-[var(--primary)] mb-2">Kirim Kado Fisik</p>
                ...
                <section id="ucapan" class="relative px-4 py-16 overflow-hidden">
                    ...
                    <div class="glass-panel w-full max-w-md mx-auto text-center px-6 py-16">
                        <p class="reveal font-serif tracking-[0.35em] text-xs uppercase text-[var(--primary)] mb-2">RSVP</p>
                        <h2 class="reveal font-script text-5xl mb-10">Ucapan &amp; Doa</h2>

                        <form @submit.prevent="submitWish" class="reveal text-left space-y-4 border border-[var(--primary-soft)] rounded-2xl p-6 bg-white/50 shadow-sm">
                            <div>
                                <input v-model="form.name" required type="text" placeholder="Nama" class="w-full border border-[var(--primary-soft)] rounded-lg px-4 py-3 bg-white/70 text-sm focus:outline-none focus:border-[var(--primary)] placeholder-[var(--ink)]/40 transition-colors">
                            </div>
                            <div>
                                <textarea v-model="form.message" required rows="3" placeholder="Ucapan" class="w-full border border-[var(--primary-soft)] rounded-lg px-4 py-3 bg-white/70 text-sm focus:outline-none focus:border-[var(--primary)] placeholder-[var(--ink)]/40 transition-colors"></textarea>
                            </div>
                            
                            <div class="pt-2 pb-2">
                                <div class="flex items-center gap-4 mb-4">
                                    <hr class="flex-grow border-[var(--primary-soft)]">
                                ...
                                <div class="flex gap-3">
                                    <label class="flex-1 relative">
                                        ...
                                        <div class="w-full text-center py-2.5 rounded-full bg-black/5 text-[var(--ink)]/50 text-sm font-semibold cursor-pointer peer-checked:bg-[var(--primary-soft)] peer-checked:text-[var(--ink)] transition-all flex items-center justify-center gap-1.5 border border-transparent peer-checked:border-[var(--primary)]">
                                    ...
                                    <label class="flex-1 relative">
                                        ...
                                        <div class="w-full text-center py-2.5 rounded-full bg-black/5 text-[var(--ink)]/50 text-sm font-semibold cursor-pointer peer-checked:bg-gray-200 peer-checked:text-gray-700 transition-all flex items-center justify-center gap-1.5 border border-transparent peer-checked:border-gray-300">
                            ...
                            <p class="text-xs text-[var(--primary)] font-semibold text-center h-4">{{ rsvpMsg }}</p>
                        </form>
                        ...
                        <div class="mt-14 relative">
                            <div class="space-y-4 text-left max-h-[360px] overflow-y-auto pr-2 hide-scrollbar">
                                ...
                                <div v-for="wish in pagedWishes" :key="wish.id" class="bg-white/70 p-4 rounded-xl shadow-sm border border-white flex gap-4">
                                    <div 
                                        class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs shrink-0"
                                        :class="wish.attendance === 'hadir' ? 'bg-[var(--primary-soft)] text-[var(--ink)]' : 'bg-gray-200 text-gray-500'"
                                    >
                                        {{ initials(wish.name) }}
                                    </div>
                                    <div class="flex-1">
                                        <p class="font-bold text-[13px] text-[var(--ink)] mb-0.5 flex items-center justify-between">
                                            ...
                                            <span 
                                                ...
                                                :class="wish.attendance === 'hadir' ? 'bg-[var(--primary-soft)] text-[var(--ink)]' : 'bg-gray-200 text-gray-600'"
                                            >
                            ...
                            <div v-if="wishes.length" class="flex items-center justify-center gap-2 mt-6">
                                <button
                                    ...
                                    class="w-8 h-8 rounded-full flex items-center justify-center border border-[var(--primary-soft)] text-[var(--ink)] transition-all"
                                    :class="wishesPage === 1 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[var(--primary-soft)]'"
                                >
                                ...
                                <button
                                    ...
                                    :class="p === wishesPage ? 'bg-[var(--ink)] text-[var(--cream)]' : 'border border-[var(--primary-soft)] text-[var(--ink)] hover:bg-[var(--primary-soft)]'"
                                >
                                    {{ p }}
                                </button>
                                <button
                                    ...
                                    class="w-8 h-8 rounded-full flex items-center justify-center border border-[var(--primary-soft)] text-[var(--ink)] transition-all"
                                    :class="wishesPage === totalWishesPages ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[var(--primary-soft)]'"
                                >
                ...
                <section class="relative px-4 py-16 overflow-hidden">
                    ...
                    <svg class="absolute top-20 left-1/2 -translate-x-1/2 w-16 h-16 text-[var(--primary)] opacity-20" viewBox="0 0 60 60" fill="currentColor">
                        <path d="M30 30c-4-4-10-8-15-4 0 6 5 8 9 9-5 1-9 5-9 9 6 0 10-4 15-8 5 4 9 8 15 8 0-4-4-8-9-9 4-1 9-3 9-9-5-4-11 0-15 4z"/>
                    </svg>
                    ...
                    <div class="glass-panel w-full max-w-md mx-auto text-center px-6 py-16">
                        ...
                        <p class="reveal text-xs tracking-widest uppercase text-[var(--primary)] mb-2">Kami Yang Berbahagia</p>
                ...
                <footer class="text-center py-8 border-t border-[var(--primary-soft)]">
...
<style>
  ...
  .corner-wrap img{width:100%; display:block; opacity:0.65; animation:pulseZoom 5.5s ease-in-out infinite; filter:hue-rotate(240deg) brightness(1.2) contrast(0.9);}
  ...
  .glass-panel {
    ...
    box-shadow: 0 8px 32px rgba(155, 107, 158, 0.1);
    border-radius: 1.5rem;
    position: relative;
    z-index: 10;
  }

  .divider-line{height:1px; background:linear-gradient(90deg, transparent, var(--primary), transparent);}
  ...
  .butterfly{
    position:absolute; top:-10%; opacity:0.85; 
    animation:flutterFall linear infinite; pointer-events:none;
  ...
  .butterfly-wing-left{ transform-origin: right center; animation: flap-left 0.3s ease-in-out infinite alternate; }
  .butterfly-wing-right{ transform-origin: left center; animation: flap-right 0.3s ease-in-out infinite alternate; }
  
  @keyframes flutterFall{
    0%{transform:translateY(0) translateX(0) rotate(0deg); opacity:0;}
    10%{opacity:1;}
    50%{transform:translateY(55vh) translateX(30px) rotate(15deg);}
    90%{opacity:1;}
  ...
  .btn-primary:hover:not(:disabled){background:var(--primary); transform:translateY(-2px);}
  ...
  .photo-frame .corner-bottom{width:180px; height:auto; object-fit:contain; opacity:0.8; margin-top:-45px; position:relative; z-index:10; animation:cornerZoom 4s ease-in-out infinite; filter:hue-rotate(240deg) brightness(1.2) contrast(0.9);}
  .photo-frame .photo-ring{position:relative; width:220px; height:280px; border-radius:110px 110px 12px 12px; border:3px solid #fff; box-shadow:0 8px 24px rgba(74,44,89,0.18), 0 0 0 1px var(--primary-soft); overflow:hidden; background:var(--primary-soft)/40; z-index:2;}
  ...
  .anim-pulse { animation: pulseZoom 5.5s ease-in-out infinite; filter:hue-rotate(240deg) brightness(1.2) contrast(0.9); }
  .anim-pulse-delay { animation: pulseZoom 5.5s ease-in-out infinite; animation-delay: 2s; filter:hue-rotate(240deg) brightness(1.2) contrast(0.9); }
  ...
  #bottomNav{
    ...
    box-shadow:0 12px 40px rgba(74,44,89,0.15);
  ...
  .nav-icon{display:flex; flex-direction:column; align-items:center; gap:4px; color:rgba(74,44,89,0.45); transition:all .3s ease; width:44px;}
